...
import {sortProperties} from '../js/app'
...
test("сортировка свойств объектов персонажей согласно порядку в указанном массиве, остальные - в алфавитном порядке", () => {
  const input1 = new Zombie("TestMan");
  const input2 = ["name", "level"]; // sortArray, данный в условии
